//
//  HeadersCollectionViewCell.swift
//  MoviesMVVM
//
...
class UpcomingMoviesHeaderCell: UICollectionViewCell {
    ...
    func itemFromCell(movie: HomeTableViewCell.ViewModel) {
    ...
    override init(frame: CGRect) {
        ...
        collectionNameLabel.textColor = .white
        ...
        collectionImdbLabel.textColor = .white
